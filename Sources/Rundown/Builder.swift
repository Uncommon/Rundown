...
///
/// This type must be public to be usable in the result builder,
...
public struct Accumulator<Phase: AccumulatorPhase> {
  ...
  internal var data: AccumulatorData

  internal init() {
    self.data = .init()
  }

  internal init(data: AccumulatorData) {
    self.data = data
  }

  internal init<OtherPhase: AccumulatorPhase>(other: Accumulator<OtherPhase>) {
    self.data = other.data
  }
}

internal extension Accumulator {
